...
inline ref<java::lang::String> SSLEngine::getApplicationProtocol() { return call_method<SCAPIX_META_STRING("getApplicationProtocol"), ref<java::lang::String>>(); }
inline ref<java::lang::String> SSLEngine::getHandshakeApplicationProtocol() { return call_method<SCAPIX_META_STRING("getHandshakeApplicationProtocol"), ref<java::lang::String>>(); }
inline void SSLEngine::setHandshakeApplicationProtocolSelector(ref<java::util::function::BiFunction> selector) { return call_method<SCAPIX_META_STRING("setHandshakeApplicationProtocolSelector"), void>(selector); }
inline ref<java::util::function::BiFunction> SSLEngine::getHandshakeApplicationProtocolSelector() { return call_method<SCAPIX_META_STRING("getHandshakeApplicationProtocolSelector"), ref<java::util::function::BiFunction>>(); }
