...
public:
	...
	static ref<javax::net::ssl::SSLEngineResult_HandshakeStatus> NEED_UNWRAP_AGAIN_();
...
inline ref<javax::net::ssl::SSLEngineResult_HandshakeStatus> SSLEngineResult_HandshakeStatus::NEED_UNWRAP_AGAIN_() { return get_static_field<SCAPIX_META_STRING("NEED_UNWRAP_AGAIN"), ref<javax::net::ssl::SSLEngineResult_HandshakeStatus>>(); }
