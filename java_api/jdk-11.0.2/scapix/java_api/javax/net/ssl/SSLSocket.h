...
public:
	...
	ref<java::lang::String> getApplicationProtocol();
	ref<java::lang::String> getHandshakeApplicationProtocol();
	void setHandshakeApplicationProtocolSelector(ref<java::util::function::BiFunction> selector);
	ref<java::util::function::BiFunction> getHandshakeApplicationProtocolSelector();
...
inline ref<java::lang::String> SSLSocket::getApplicationProtocol() { return call_method<SCAPIX_META_STRING("getApplicationProtocol"), ref<java::lang::String>>(); }
inline ref<java::lang::String> SSLSocket::getHandshakeApplicationProtocol() { return call_method<SCAPIX_META_STRING("getHandshakeApplicationProtocol"), ref<java::lang::String>>(); }
inline void SSLSocket::setHandshakeApplicationProtocolSelector(ref<java::util::function::BiFunction> selector) { return call_method<SCAPIX_META_STRING("setHandshakeApplicationProtocolSelector"), void>(selector); }
inline ref<java::util::function::BiFunction> SSLSocket::getHandshakeApplicationProtocolSelector() { return call_method<SCAPIX_META_STRING("getHandshakeApplicationProtocolSelector"), ref<java::util::function::BiFunction>>(); }
