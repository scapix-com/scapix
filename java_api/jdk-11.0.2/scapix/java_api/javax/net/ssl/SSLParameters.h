...
public:
	...
	void setEnableRetransmissions(jboolean enableRetransmissions);
	jboolean getEnableRetransmissions();
	void setMaximumPacketSize(jint maximumPacketSize);
	jint getMaximumPacketSize();
	ref<link::java::array<java::lang::String>> getApplicationProtocols();
	void setApplicationProtocols(ref<link::java::array<java::lang::String>> protocols);
...
inline void SSLParameters::setEnableRetransmissions(jboolean enableRetransmissions) { return call_method<SCAPIX_META_STRING("setEnableRetransmissions"), void>(enableRetransmissions); }
inline jboolean SSLParameters::getEnableRetransmissions() { return call_method<SCAPIX_META_STRING("getEnableRetransmissions"), jboolean>(); }
inline void SSLParameters::setMaximumPacketSize(jint maximumPacketSize) { return call_method<SCAPIX_META_STRING("setMaximumPacketSize"), void>(maximumPacketSize); }
inline jint SSLParameters::getMaximumPacketSize() { return call_method<SCAPIX_META_STRING("getMaximumPacketSize"), jint>(); }
inline ref<link::java::array<java::lang::String>> SSLParameters::getApplicationProtocols() { return call_method<SCAPIX_META_STRING("getApplicationProtocols"), ref<link::java::array<java::lang::String>>>(); }
inline void SSLParameters::setApplicationProtocols(ref<link::java::array<java::lang::String>> protocols) { return call_method<SCAPIX_META_STRING("setApplicationProtocols"), void>(protocols); }
