...
public:
	...
	ref<java::util::List> getStatusResponses();
...
inline ref<java::util::List> ExtendedSSLSession::getStatusResponses() { return call_method<SCAPIX_META_STRING("getStatusResponses"), ref<java::util::List>>(); }
