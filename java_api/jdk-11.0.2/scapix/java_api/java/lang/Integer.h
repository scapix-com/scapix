...
public:
	...
	static jint parseInt(ref<java::lang::CharSequence> s, jint beginIndex, jint endIndex, jint radix);
	static jint parseInt(ref<java::lang::String> s);
	static jint parseUnsignedInt(ref<java::lang::String> s, jint radix);
	static jint parseUnsignedInt(ref<java::lang::CharSequence> s, jint beginIndex, jint endIndex, jint radix);
...
inline jint Integer::parseInt(ref<java::lang::CharSequence> s, jint beginIndex, jint endIndex, jint radix) { return call_static_method<SCAPIX_META_STRING("parseInt"), jint>(s, beginIndex, endIndex, radix); }
...
inline jint Integer::parseUnsignedInt(ref<java::lang::CharSequence> s, jint beginIndex, jint endIndex, jint radix) { return call_static_method<SCAPIX_META_STRING("parseUnsignedInt"), jint>(s, beginIndex, endIndex, radix); }
