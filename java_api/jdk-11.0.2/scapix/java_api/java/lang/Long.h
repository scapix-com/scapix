...
public:
	...
	static jlong parseLong(ref<java::lang::CharSequence> s, jint beginIndex, jint endIndex, jint radix);
	static jlong parseLong(ref<java::lang::String> s);
	static jlong parseUnsignedLong(ref<java::lang::String> s, jint radix);
	static jlong parseUnsignedLong(ref<java::lang::CharSequence> s, jint beginIndex, jint endIndex, jint radix);
...
inline jlong Long::parseLong(ref<java::lang::CharSequence> s, jint beginIndex, jint endIndex, jint radix) { return call_static_method<SCAPIX_META_STRING("parseLong"), jlong>(s, beginIndex, endIndex, radix); }
...
inline jlong Long::parseUnsignedLong(ref<java::lang::CharSequence> s, jint beginIndex, jint endIndex, jint radix) { return call_static_method<SCAPIX_META_STRING("parseUnsignedLong"), jlong>(s, beginIndex, endIndex, radix); }
