...
inline void Constructor::setAccessible(jboolean flag) { return call_method<SCAPIX_META_STRING("setAccessible"), void>(flag); }
...
inline ref<java::lang::reflect::AnnotatedType> Constructor::getAnnotatedReturnType() { return call_method<SCAPIX_META_STRING("getAnnotatedReturnType"), ref<java::lang::reflect::AnnotatedType>>(); }
inline ref<java::lang::reflect::AnnotatedType> Constructor::getAnnotatedReceiverType() { return call_method<SCAPIX_META_STRING("getAnnotatedReceiverType"), ref<java::lang::reflect::AnnotatedType>>(); }
