...
public:
	...
	static ref<StackTraceElement> new_object(ref<java::lang::String> classLoaderName, ref<java::lang::String> moduleName, ref<java::lang::String> moduleVersion, ref<java::lang::String> declaringClass, ref<java::lang::String> methodName, ref<java::lang::String> fileName, jint lineNumber);
	ref<java::lang::String> getFileName();
	jint getLineNumber();
	ref<java::lang::String> getModuleName();
	ref<java::lang::String> getModuleVersion();
	ref<java::lang::String> getClassLoaderName();
...
inline ref<StackTraceElement> StackTraceElement::new_object(ref<java::lang::String> classLoaderName, ref<java::lang::String> moduleName, ref<java::lang::String> moduleVersion, ref<java::lang::String> declaringClass, ref<java::lang::String> methodName, ref<java::lang::String> fileName, jint lineNumber) { return base_::new_object(classLoaderName, moduleName, moduleVersion, declaringClass, methodName, fileName, lineNumber); }
...
inline ref<java::lang::String> StackTraceElement::getModuleName() { return call_method<SCAPIX_META_STRING("getModuleName"), ref<java::lang::String>>(); }
inline ref<java::lang::String> StackTraceElement::getModuleVersion() { return call_method<SCAPIX_META_STRING("getModuleVersion"), ref<java::lang::String>>(); }
inline ref<java::lang::String> StackTraceElement::getClassLoaderName() { return call_method<SCAPIX_META_STRING("getClassLoaderName"), ref<java::lang::String>>(); }
