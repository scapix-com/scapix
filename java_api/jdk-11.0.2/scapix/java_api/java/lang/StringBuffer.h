...
public:
	...
	jint compareTo(ref<java::lang::StringBuffer> another);
	jint length();
	jint capacity();
...
inline jint StringBuffer::compareTo(ref<java::lang::StringBuffer> another) { return call_method<SCAPIX_META_STRING("compareTo"), jint>(another); }
