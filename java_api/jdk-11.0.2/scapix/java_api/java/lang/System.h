...
namespace java::lang { class System_LoggerFinder; }
...
public:
	...
	using LoggerFinder = System_LoggerFinder;
	using Logger = System_Logger;
	...
	static jint identityHashCode(ref<java::lang::Object> p1);
	...
	static ref<java::lang::System_Logger> getLogger(ref<java::lang::String> name);
	static ref<java::lang::System_Logger> getLogger(ref<java::lang::String> name, ref<java::util::ResourceBundle> bundle);
...
inline jint System::identityHashCode(ref<java::lang::Object> p1) { return call_static_method<SCAPIX_META_STRING("identityHashCode"), jint>(p1); }
...
inline ref<java::lang::System_Logger> System::getLogger(ref<java::lang::String> name) { return call_static_method<SCAPIX_META_STRING("getLogger"), ref<java::lang::System_Logger>>(name); }
inline ref<java::lang::System_Logger> System::getLogger(ref<java::lang::String> name, ref<java::util::ResourceBundle> bundle) { return call_static_method<SCAPIX_META_STRING("getLogger"), ref<java::lang::System_Logger>>(name, bundle); }
