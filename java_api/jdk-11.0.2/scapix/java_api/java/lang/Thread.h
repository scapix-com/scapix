...
public:
	...
	static ref<Thread> new_object(ref<java::lang::ThreadGroup> group, ref<java::lang::Runnable> target, ref<java::lang::String> name, jlong stackSize, jboolean p5);
	void start();
	void run();
	void stop();
	void interrupt();
	...
	static jboolean holdsLock(ref<java::lang::Object> p1);
...
inline void Thread::sleep(jlong p1) { return call_static_method<SCAPIX_META_STRING("sleep"), void>(p1); }
inline void Thread::sleep(jlong millis, jint p2) { return call_static_method<SCAPIX_META_STRING("sleep"), void>(millis, p2); }
inline void Thread::onSpinWait() { return call_static_method<SCAPIX_META_STRING("onSpinWait"), void>(); }
...
inline ref<Thread> Thread::new_object(ref<java::lang::ThreadGroup> group, ref<java::lang::Runnable> target, ref<java::lang::String> name, jlong stackSize, jboolean p5) { return base_::new_object(group, target, name, stackSize, p5); }
...
inline jboolean Thread::holdsLock(ref<java::lang::Object> p1) { return call_static_method<SCAPIX_META_STRING("holdsLock"), jboolean>(p1); }
