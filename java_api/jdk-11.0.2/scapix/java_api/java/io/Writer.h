...
public:
	...
	static ref<java::io::Writer> nullWriter();
	void write(jint c);
...
inline ref<java::io::Writer> Writer::nullWriter() { return call_static_method<SCAPIX_META_STRING("nullWriter"), ref<java::io::Writer>>(); }
