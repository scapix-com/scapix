...
public:
	...
	ref<java::io::ObjectInputFilter> getObjectInputFilter();
	void setObjectInputFilter(ref<java::io::ObjectInputFilter> filter);
...
inline ref<java::io::ObjectInputFilter> ObjectInputStream::getObjectInputFilter() { return call_method<SCAPIX_META_STRING("getObjectInputFilter"), ref<java::io::ObjectInputFilter>>(); }
inline void ObjectInputStream::setObjectInputFilter(ref<java::io::ObjectInputFilter> filter) { return call_method<SCAPIX_META_STRING("setObjectInputFilter"), void>(filter); }
