...
public:
	...
	static ref<PrintWriter> new_object(ref<java::io::OutputStream> out, jboolean autoFlush, ref<java::nio::charset::Charset> charset);
	...
	static ref<PrintWriter> new_object(ref<java::lang::String> fileName, ref<java::nio::charset::Charset> charset);
	...
	static ref<PrintWriter> new_object(ref<java::io::File> file, ref<java::nio::charset::Charset> charset);
	void flush();
	void close();
	jboolean checkError();
	void write(jint c);
...
inline ref<PrintWriter> PrintWriter::new_object(ref<java::io::OutputStream> out, jboolean autoFlush, ref<java::nio::charset::Charset> charset) { return base_::new_object(out, autoFlush, charset); }
...
inline ref<PrintWriter> PrintWriter::new_object(ref<java::lang::String> fileName, ref<java::nio::charset::Charset> charset) { return base_::new_object(fileName, charset); }
...
inline ref<PrintWriter> PrintWriter::new_object(ref<java::io::File> file, ref<java::nio::charset::Charset> charset) { return base_::new_object(file, charset); }
