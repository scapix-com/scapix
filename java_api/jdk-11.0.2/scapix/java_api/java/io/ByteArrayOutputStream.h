...
public:
	...
	void writeBytes(ref<link::java::array<jbyte>> b);
	...
	ref<java::lang::String> toString(ref<java::nio::charset::Charset> charset);
...
inline void ByteArrayOutputStream::writeBytes(ref<link::java::array<jbyte>> b) { return call_method<SCAPIX_META_STRING("writeBytes"), void>(b); }
...
inline ref<java::lang::String> ByteArrayOutputStream::toString(ref<java::nio::charset::Charset> charset) { return call_method<SCAPIX_META_STRING("toString"), ref<java::lang::String>>(charset); }
