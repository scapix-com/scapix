...
public:
	...
	ref<java::util::stream::Stream> inetAddresses();
	ref<java::util::List> getInterfaceAddresses();
	ref<java::util::Enumeration> getSubInterfaces();
	ref<java::util::stream::Stream> subInterfaces();
	...
	static ref<java::util::stream::Stream> networkInterfaces();
	jboolean isUp();
	jboolean isLoopback();
...
inline ref<java::util::stream::Stream> NetworkInterface::inetAddresses() { return call_method<SCAPIX_META_STRING("inetAddresses"), ref<java::util::stream::Stream>>(); }
...
inline ref<java::util::stream::Stream> NetworkInterface::subInterfaces() { return call_method<SCAPIX_META_STRING("subInterfaces"), ref<java::util::stream::Stream>>(); }
...
inline ref<java::util::stream::Stream> NetworkInterface::networkInterfaces() { return call_static_method<SCAPIX_META_STRING("networkInterfaces"), ref<java::util::stream::Stream>>(); }
