...
public:
	...
	static ref<java::net::SocketOption> SO_REUSEPORT_();
...
inline ref<java::net::SocketOption> StandardSocketOptions::SO_REUSEPORT_() { return get_static_field<SCAPIX_META_STRING("SO_REUSEPORT"), ref<java::net::SocketOption>>(); }
