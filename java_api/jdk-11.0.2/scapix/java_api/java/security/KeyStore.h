...
public:
	...
	static ref<java::security::KeyStore> getInstance(ref<java::io::File> file, ref<link::java::array<jchar>> password);
	static ref<java::security::KeyStore> getInstance(ref<java::io::File> file, ref<java::security::KeyStore_LoadStoreParameter> param);
...
inline ref<java::security::KeyStore> KeyStore::getInstance(ref<java::io::File> file, ref<link::java::array<jchar>> password) { return call_static_method<SCAPIX_META_STRING("getInstance"), ref<java::security::KeyStore>>(file, password); }
inline ref<java::security::KeyStore> KeyStore::getInstance(ref<java::io::File> file, ref<java::security::KeyStore_LoadStoreParameter> param) { return call_static_method<SCAPIX_META_STRING("getInstance"), ref<java::security::KeyStore>>(file, param); }
