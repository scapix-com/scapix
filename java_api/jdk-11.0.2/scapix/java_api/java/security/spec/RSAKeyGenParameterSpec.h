...
public:
	...
	static ref<RSAKeyGenParameterSpec> new_object(jint keysize, ref<java::math::BigInteger> publicExponent, ref<java::security::spec::AlgorithmParameterSpec> keyParams);
	jint getKeysize();
	ref<java::math::BigInteger> getPublicExponent();
	ref<java::security::spec::AlgorithmParameterSpec> getKeyParams();
...
inline ref<RSAKeyGenParameterSpec> RSAKeyGenParameterSpec::new_object(jint keysize, ref<java::math::BigInteger> publicExponent, ref<java::security::spec::AlgorithmParameterSpec> keyParams) { return base_::new_object(keysize, publicExponent, keyParams); }
...
inline ref<java::security::spec::AlgorithmParameterSpec> RSAKeyGenParameterSpec::getKeyParams() { return call_method<SCAPIX_META_STRING("getKeyParams"), ref<java::security::spec::AlgorithmParameterSpec>>(); }
