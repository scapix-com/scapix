...
public:
	...
	ref<java::security::Provider> configure(ref<java::lang::String> configArg);
	jboolean isConfigured();
	ref<java::lang::String> getName();
	jdouble getVersion();
	ref<java::lang::String> getVersionStr();
...
inline ref<java::security::Provider> Provider::configure(ref<java::lang::String> configArg) { return call_method<SCAPIX_META_STRING("configure"), ref<java::security::Provider>>(configArg); }
inline jboolean Provider::isConfigured() { return call_method<SCAPIX_META_STRING("isConfigured"), jboolean>(); }
...
inline ref<java::lang::String> Provider::getVersionStr() { return call_method<SCAPIX_META_STRING("getVersionStr"), ref<java::lang::String>>(); }
