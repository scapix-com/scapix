...
public:
	...
	jboolean compareAndSet(jint expectedValue, jint newValue);
	jboolean weakCompareAndSet(jint expectedValue, jint newValue);
	jboolean weakCompareAndSetPlain(jint expectedValue, jint newValue);
	...
	jdouble doubleValue();
	jint getPlain();
	void setPlain(jint newValue);
	jint getOpaque();
	void setOpaque(jint newValue);
	jint getAcquire();
	void setRelease(jint newValue);
	jint compareAndExchange(jint expectedValue, jint newValue);
	jint compareAndExchangeAcquire(jint expectedValue, jint newValue);
	jint compareAndExchangeRelease(jint expectedValue, jint newValue);
	jboolean weakCompareAndSetVolatile(jint expectedValue, jint newValue);
	jboolean weakCompareAndSetAcquire(jint expectedValue, jint newValue);
	jboolean weakCompareAndSetRelease(jint expectedValue, jint newValue);
...
inline jboolean AtomicInteger::compareAndSet(jint expectedValue, jint newValue) { return call_method<SCAPIX_META_STRING("compareAndSet"), jboolean>(expectedValue, newValue); }
inline jboolean AtomicInteger::weakCompareAndSet(jint expectedValue, jint newValue) { return call_method<SCAPIX_META_STRING("weakCompareAndSet"), jboolean>(expectedValue, newValue); }
inline jboolean AtomicInteger::weakCompareAndSetPlain(jint expectedValue, jint newValue) { return call_method<SCAPIX_META_STRING("weakCompareAndSetPlain"), jboolean>(expectedValue, newValue); }
...
inline jint AtomicInteger::getPlain() { return call_method<SCAPIX_META_STRING("getPlain"), jint>(); }
inline void AtomicInteger::setPlain(jint newValue) { return call_method<SCAPIX_META_STRING("setPlain"), void>(newValue); }
inline jint AtomicInteger::getOpaque() { return call_method<SCAPIX_META_STRING("getOpaque"), jint>(); }
inline void AtomicInteger::setOpaque(jint newValue) { return call_method<SCAPIX_META_STRING("setOpaque"), void>(newValue); }
inline jint AtomicInteger::getAcquire() { return call_method<SCAPIX_META_STRING("getAcquire"), jint>(); }
inline void AtomicInteger::setRelease(jint newValue) { return call_method<SCAPIX_META_STRING("setRelease"), void>(newValue); }
inline jint AtomicInteger::compareAndExchange(jint expectedValue, jint newValue) { return call_method<SCAPIX_META_STRING("compareAndExchange"), jint>(expectedValue, newValue); }
inline jint AtomicInteger::compareAndExchangeAcquire(jint expectedValue, jint newValue) { return call_method<SCAPIX_META_STRING("compareAndExchangeAcquire"), jint>(expectedValue, newValue); }
inline jint AtomicInteger::compareAndExchangeRelease(jint expectedValue, jint newValue) { return call_method<SCAPIX_META_STRING("compareAndExchangeRelease"), jint>(expectedValue, newValue); }
inline jboolean AtomicInteger::weakCompareAndSetVolatile(jint expectedValue, jint newValue) { return call_method<SCAPIX_META_STRING("weakCompareAndSetVolatile"), jboolean>(expectedValue, newValue); }
inline jboolean AtomicInteger::weakCompareAndSetAcquire(jint expectedValue, jint newValue) { return call_method<SCAPIX_META_STRING("weakCompareAndSetAcquire"), jboolean>(expectedValue, newValue); }
inline jboolean AtomicInteger::weakCompareAndSetRelease(jint expectedValue, jint newValue) { return call_method<SCAPIX_META_STRING("weakCompareAndSetRelease"), jboolean>(expectedValue, newValue); }
