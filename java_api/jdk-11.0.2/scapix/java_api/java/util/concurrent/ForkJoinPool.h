...
public:
	...
	static ref<ForkJoinPool> new_object(jint parallelism, ref<java::util::concurrent::ForkJoinPool_ForkJoinWorkerThreadFactory> factory, ref<java::lang::Thread_UncaughtExceptionHandler> handler, jboolean asyncMode, jint corePoolSize, jint maximumPoolSize, jint minimumRunnable, ref<java::util::function::Predicate> saturate, jlong keepAliveTime, ref<java::util::concurrent::TimeUnit> p10);
...
inline ref<ForkJoinPool> ForkJoinPool::new_object(jint parallelism, ref<java::util::concurrent::ForkJoinPool_ForkJoinWorkerThreadFactory> factory, ref<java::lang::Thread_UncaughtExceptionHandler> handler, jboolean asyncMode, jint corePoolSize, jint maximumPoolSize, jint minimumRunnable, ref<java::util::function::Predicate> saturate, jlong keepAliveTime, ref<java::util::concurrent::TimeUnit> p10) { return base_::new_object(parallelism, factory, handler, asyncMode, corePoolSize, maximumPoolSize, minimumRunnable, saturate, keepAliveTime, p10); }
