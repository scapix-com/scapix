...
public:
	...
	static jboolean equals(ref<link::java::array<jlong>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jlong>> b, jint bFromIndex, jint bToIndex);
	static jboolean equals(ref<link::java::array<jint>> a, ref<link::java::array<jint>> a2);
	static jboolean equals(ref<link::java::array<jint>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jint>> b, jint bFromIndex, jint bToIndex);
	static jboolean equals(ref<link::java::array<jshort>> a, ref<link::java::array<jshort>> a2);
	static jboolean equals(ref<link::java::array<jshort>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jshort>> b, jint bFromIndex, jint bToIndex);
	static jboolean equals(ref<link::java::array<jchar>> a, ref<link::java::array<jchar>> a2);
	static jboolean equals(ref<link::java::array<jchar>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jchar>> b, jint bFromIndex, jint bToIndex);
	static jboolean equals(ref<link::java::array<jbyte>> a, ref<link::java::array<jbyte>> a2);
	static jboolean equals(ref<link::java::array<jbyte>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jbyte>> b, jint bFromIndex, jint bToIndex);
	static jboolean equals(ref<link::java::array<jboolean>> a, ref<link::java::array<jboolean>> a2);
	static jboolean equals(ref<link::java::array<jboolean>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jboolean>> b, jint bFromIndex, jint bToIndex);
	static jboolean equals(ref<link::java::array<jdouble>> a, ref<link::java::array<jdouble>> a2);
	static jboolean equals(ref<link::java::array<jdouble>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jdouble>> b, jint bFromIndex, jint bToIndex);
	static jboolean equals(ref<link::java::array<jfloat>> a, ref<link::java::array<jfloat>> a2);
	static jboolean equals(ref<link::java::array<jfloat>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jfloat>> b, jint bFromIndex, jint bToIndex);
	static jboolean equals(ref<link::java::array<java::lang::Object>> a, ref<link::java::array<java::lang::Object>> a2);
	static jboolean equals(ref<link::java::array<java::lang::Object>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Object>> b, jint bFromIndex, jint bToIndex);
	static jboolean equals(ref<link::java::array<java::lang::Object>> a, ref<link::java::array<java::lang::Object>> a2, ref<java::util::Comparator> cmp);
	static jboolean equals(ref<link::java::array<java::lang::Object>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Object>> b, jint bFromIndex, jint bToIndex, ref<java::util::Comparator> cmp);
	...
	static jint compare(ref<link::java::array<jboolean>> a, ref<link::java::array<jboolean>> b);
	static jint compare(ref<link::java::array<jboolean>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jboolean>> b, jint bFromIndex, jint bToIndex);
	static jint compare(ref<link::java::array<jbyte>> a, ref<link::java::array<jbyte>> b);
	static jint compare(ref<link::java::array<jbyte>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jbyte>> b, jint bFromIndex, jint bToIndex);
	static jint compareUnsigned(ref<link::java::array<jbyte>> a, ref<link::java::array<jbyte>> b);
	static jint compareUnsigned(ref<link::java::array<jbyte>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jbyte>> b, jint bFromIndex, jint bToIndex);
	static jint compare(ref<link::java::array<jshort>> a, ref<link::java::array<jshort>> b);
	static jint compare(ref<link::java::array<jshort>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jshort>> b, jint bFromIndex, jint bToIndex);
	static jint compareUnsigned(ref<link::java::array<jshort>> a, ref<link::java::array<jshort>> b);
	static jint compareUnsigned(ref<link::java::array<jshort>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jshort>> b, jint bFromIndex, jint bToIndex);
	static jint compare(ref<link::java::array<jchar>> a, ref<link::java::array<jchar>> b);
	static jint compare(ref<link::java::array<jchar>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jchar>> b, jint bFromIndex, jint bToIndex);
	static jint compare(ref<link::java::array<jint>> a, ref<link::java::array<jint>> b);
	static jint compare(ref<link::java::array<jint>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jint>> b, jint bFromIndex, jint bToIndex);
	static jint compareUnsigned(ref<link::java::array<jint>> a, ref<link::java::array<jint>> b);
	static jint compareUnsigned(ref<link::java::array<jint>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jint>> b, jint bFromIndex, jint bToIndex);
	static jint compare(ref<link::java::array<jlong>> a, ref<link::java::array<jlong>> b);
	static jint compare(ref<link::java::array<jlong>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jlong>> b, jint bFromIndex, jint bToIndex);
	static jint compareUnsigned(ref<link::java::array<jlong>> a, ref<link::java::array<jlong>> b);
	static jint compareUnsigned(ref<link::java::array<jlong>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jlong>> b, jint bFromIndex, jint bToIndex);
	static jint compare(ref<link::java::array<jfloat>> a, ref<link::java::array<jfloat>> b);
	static jint compare(ref<link::java::array<jfloat>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jfloat>> b, jint bFromIndex, jint bToIndex);
	static jint compare(ref<link::java::array<jdouble>> a, ref<link::java::array<jdouble>> b);
	static jint compare(ref<link::java::array<jdouble>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jdouble>> b, jint bFromIndex, jint bToIndex);
	static jint compare(ref<link::java::array<java::lang::Comparable>> a, ref<link::java::array<java::lang::Comparable>> b);
	static jint compare(ref<link::java::array<java::lang::Comparable>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Comparable>> b, jint bFromIndex, jint bToIndex);
	static jint compare(ref<link::java::array<java::lang::Object>> a, ref<link::java::array<java::lang::Object>> b, ref<java::util::Comparator> cmp);
	static jint compare(ref<link::java::array<java::lang::Object>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Object>> b, jint bFromIndex, jint bToIndex, ref<java::util::Comparator> cmp);
	static jint mismatch(ref<link::java::array<jboolean>> a, ref<link::java::array<jboolean>> b);
	static jint mismatch(ref<link::java::array<jboolean>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jboolean>> b, jint bFromIndex, jint bToIndex);
	static jint mismatch(ref<link::java::array<jbyte>> a, ref<link::java::array<jbyte>> b);
	static jint mismatch(ref<link::java::array<jbyte>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jbyte>> b, jint bFromIndex, jint bToIndex);
	static jint mismatch(ref<link::java::array<jchar>> a, ref<link::java::array<jchar>> b);
	static jint mismatch(ref<link::java::array<jchar>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jchar>> b, jint bFromIndex, jint bToIndex);
	static jint mismatch(ref<link::java::array<jshort>> a, ref<link::java::array<jshort>> b);
	static jint mismatch(ref<link::java::array<jshort>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jshort>> b, jint bFromIndex, jint bToIndex);
	static jint mismatch(ref<link::java::array<jint>> a, ref<link::java::array<jint>> b);
	static jint mismatch(ref<link::java::array<jint>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jint>> b, jint bFromIndex, jint bToIndex);
	static jint mismatch(ref<link::java::array<jlong>> a, ref<link::java::array<jlong>> b);
	static jint mismatch(ref<link::java::array<jlong>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jlong>> b, jint bFromIndex, jint bToIndex);
	static jint mismatch(ref<link::java::array<jfloat>> a, ref<link::java::array<jfloat>> b);
	static jint mismatch(ref<link::java::array<jfloat>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jfloat>> b, jint bFromIndex, jint bToIndex);
	static jint mismatch(ref<link::java::array<jdouble>> a, ref<link::java::array<jdouble>> b);
	static jint mismatch(ref<link::java::array<jdouble>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jdouble>> b, jint bFromIndex, jint bToIndex);
	static jint mismatch(ref<link::java::array<java::lang::Object>> a, ref<link::java::array<java::lang::Object>> b);
	static jint mismatch(ref<link::java::array<java::lang::Object>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Object>> b, jint bFromIndex, jint bToIndex);
	static jint mismatch(ref<link::java::array<java::lang::Object>> a, ref<link::java::array<java::lang::Object>> b, ref<java::util::Comparator> cmp);
	static jint mismatch(ref<link::java::array<java::lang::Object>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Object>> b, jint bFromIndex, jint bToIndex, ref<java::util::Comparator> cmp);
...
inline jboolean Arrays::equals(ref<link::java::array<jlong>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jlong>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
...
inline jboolean Arrays::equals(ref<link::java::array<jint>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jint>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
...
inline jboolean Arrays::equals(ref<link::java::array<jshort>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jshort>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
...
inline jboolean Arrays::equals(ref<link::java::array<jchar>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jchar>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
...
inline jboolean Arrays::equals(ref<link::java::array<jbyte>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jbyte>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
...
inline jboolean Arrays::equals(ref<link::java::array<jboolean>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jboolean>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
...
inline jboolean Arrays::equals(ref<link::java::array<jdouble>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jdouble>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
...
inline jboolean Arrays::equals(ref<link::java::array<jfloat>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jfloat>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
...
inline jboolean Arrays::equals(ref<link::java::array<java::lang::Object>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Object>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jboolean Arrays::equals(ref<link::java::array<java::lang::Object>> a, ref<link::java::array<java::lang::Object>> a2, ref<java::util::Comparator> cmp) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, a2, cmp); }
inline jboolean Arrays::equals(ref<link::java::array<java::lang::Object>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Object>> b, jint bFromIndex, jint bToIndex, ref<java::util::Comparator> cmp) { return call_static_method<SCAPIX_META_STRING("equals"), jboolean>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex, cmp); }
...
inline jint Arrays::compare(ref<link::java::array<jboolean>> a, ref<link::java::array<jboolean>> b) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, b); }
inline jint Arrays::compare(ref<link::java::array<jboolean>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jboolean>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compare(ref<link::java::array<jbyte>> a, ref<link::java::array<jbyte>> b) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, b); }
inline jint Arrays::compare(ref<link::java::array<jbyte>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jbyte>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compareUnsigned(ref<link::java::array<jbyte>> a, ref<link::java::array<jbyte>> b) { return call_static_method<SCAPIX_META_STRING("compareUnsigned"), jint>(a, b); }
inline jint Arrays::compareUnsigned(ref<link::java::array<jbyte>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jbyte>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compareUnsigned"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compare(ref<link::java::array<jshort>> a, ref<link::java::array<jshort>> b) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, b); }
inline jint Arrays::compare(ref<link::java::array<jshort>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jshort>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compareUnsigned(ref<link::java::array<jshort>> a, ref<link::java::array<jshort>> b) { return call_static_method<SCAPIX_META_STRING("compareUnsigned"), jint>(a, b); }
inline jint Arrays::compareUnsigned(ref<link::java::array<jshort>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jshort>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compareUnsigned"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compare(ref<link::java::array<jchar>> a, ref<link::java::array<jchar>> b) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, b); }
inline jint Arrays::compare(ref<link::java::array<jchar>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jchar>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compare(ref<link::java::array<jint>> a, ref<link::java::array<jint>> b) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, b); }
inline jint Arrays::compare(ref<link::java::array<jint>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jint>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compareUnsigned(ref<link::java::array<jint>> a, ref<link::java::array<jint>> b) { return call_static_method<SCAPIX_META_STRING("compareUnsigned"), jint>(a, b); }
inline jint Arrays::compareUnsigned(ref<link::java::array<jint>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jint>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compareUnsigned"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compare(ref<link::java::array<jlong>> a, ref<link::java::array<jlong>> b) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, b); }
inline jint Arrays::compare(ref<link::java::array<jlong>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jlong>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compareUnsigned(ref<link::java::array<jlong>> a, ref<link::java::array<jlong>> b) { return call_static_method<SCAPIX_META_STRING("compareUnsigned"), jint>(a, b); }
inline jint Arrays::compareUnsigned(ref<link::java::array<jlong>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jlong>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compareUnsigned"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compare(ref<link::java::array<jfloat>> a, ref<link::java::array<jfloat>> b) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, b); }
inline jint Arrays::compare(ref<link::java::array<jfloat>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jfloat>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compare(ref<link::java::array<jdouble>> a, ref<link::java::array<jdouble>> b) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, b); }
inline jint Arrays::compare(ref<link::java::array<jdouble>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jdouble>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compare(ref<link::java::array<java::lang::Comparable>> a, ref<link::java::array<java::lang::Comparable>> b) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, b); }
inline jint Arrays::compare(ref<link::java::array<java::lang::Comparable>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Comparable>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::compare(ref<link::java::array<java::lang::Object>> a, ref<link::java::array<java::lang::Object>> b, ref<java::util::Comparator> cmp) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, b, cmp); }
inline jint Arrays::compare(ref<link::java::array<java::lang::Object>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Object>> b, jint bFromIndex, jint bToIndex, ref<java::util::Comparator> cmp) { return call_static_method<SCAPIX_META_STRING("compare"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex, cmp); }
inline jint Arrays::mismatch(ref<link::java::array<jboolean>> a, ref<link::java::array<jboolean>> b) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, b); }
inline jint Arrays::mismatch(ref<link::java::array<jboolean>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jboolean>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::mismatch(ref<link::java::array<jbyte>> a, ref<link::java::array<jbyte>> b) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, b); }
inline jint Arrays::mismatch(ref<link::java::array<jbyte>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jbyte>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::mismatch(ref<link::java::array<jchar>> a, ref<link::java::array<jchar>> b) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, b); }
inline jint Arrays::mismatch(ref<link::java::array<jchar>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jchar>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::mismatch(ref<link::java::array<jshort>> a, ref<link::java::array<jshort>> b) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, b); }
inline jint Arrays::mismatch(ref<link::java::array<jshort>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jshort>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::mismatch(ref<link::java::array<jint>> a, ref<link::java::array<jint>> b) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, b); }
inline jint Arrays::mismatch(ref<link::java::array<jint>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jint>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::mismatch(ref<link::java::array<jlong>> a, ref<link::java::array<jlong>> b) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, b); }
inline jint Arrays::mismatch(ref<link::java::array<jlong>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jlong>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::mismatch(ref<link::java::array<jfloat>> a, ref<link::java::array<jfloat>> b) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, b); }
inline jint Arrays::mismatch(ref<link::java::array<jfloat>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jfloat>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::mismatch(ref<link::java::array<jdouble>> a, ref<link::java::array<jdouble>> b) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, b); }
inline jint Arrays::mismatch(ref<link::java::array<jdouble>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<jdouble>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::mismatch(ref<link::java::array<java::lang::Object>> a, ref<link::java::array<java::lang::Object>> b) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, b); }
inline jint Arrays::mismatch(ref<link::java::array<java::lang::Object>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Object>> b, jint bFromIndex, jint bToIndex) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex); }
inline jint Arrays::mismatch(ref<link::java::array<java::lang::Object>> a, ref<link::java::array<java::lang::Object>> b, ref<java::util::Comparator> cmp) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, b, cmp); }
inline jint Arrays::mismatch(ref<link::java::array<java::lang::Object>> a, jint aFromIndex, jint aToIndex, ref<link::java::array<java::lang::Object>> b, jint bFromIndex, jint bToIndex, ref<java::util::Comparator> cmp) { return call_static_method<SCAPIX_META_STRING("mismatch"), jint>(a, aFromIndex, aToIndex, b, bFromIndex, bToIndex, cmp); }
