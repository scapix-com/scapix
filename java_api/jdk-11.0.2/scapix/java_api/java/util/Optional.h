...
public:
	...
	jboolean isPresent();
	jboolean isEmpty();
	void ifPresent(ref<java::util::function::Consumer> action);
	void ifPresentOrElse(ref<java::util::function::Consumer> action, ref<java::lang::Runnable> emptyAction);
	...
	ref<java::util::Optional> or_(ref<java::util::function::Supplier> supplier);
	ref<java::util::stream::Stream> stream();
	ref<java::lang::Object> orElse(ref<java::lang::Object> other);
	ref<java::lang::Object> orElseGet(ref<java::util::function::Supplier> supplier);
	ref<java::lang::Object> orElseThrow();
...
inline jboolean Optional::isEmpty() { return call_method<SCAPIX_META_STRING("isEmpty"), jboolean>(); }
inline void Optional::ifPresent(ref<java::util::function::Consumer> action) { return call_method<SCAPIX_META_STRING("ifPresent"), void>(action); }
inline void Optional::ifPresentOrElse(ref<java::util::function::Consumer> action, ref<java::lang::Runnable> emptyAction) { return call_method<SCAPIX_META_STRING("ifPresentOrElse"), void>(action, emptyAction); }
...
inline ref<java::util::Optional> Optional::or_(ref<java::util::function::Supplier> supplier) { return call_method<SCAPIX_META_STRING("or"), ref<java::util::Optional>>(supplier); }
inline ref<java::util::stream::Stream> Optional::stream() { return call_method<SCAPIX_META_STRING("stream"), ref<java::util::stream::Stream>>(); }
...
inline ref<java::lang::Object> Optional::orElseGet(ref<java::util::function::Supplier> supplier) { return call_method<SCAPIX_META_STRING("orElseGet"), ref<java::lang::Object>>(supplier); }
inline ref<java::lang::Object> Optional::orElseThrow() { return call_method<SCAPIX_META_STRING("orElseThrow"), ref<java::lang::Object>>(); }
