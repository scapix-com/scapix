...
public:
	...
	static ref<java::util::function::Predicate> not_(ref<java::util::function::Predicate> target);
...
inline ref<java::util::function::Predicate> Predicate::not_(ref<java::util::function::Predicate> target) { return call_static_method<SCAPIX_META_STRING("not"), ref<java::util::function::Predicate>>(target); }
