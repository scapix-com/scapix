...
namespace java::util { class Locale_IsoCountryCode; }
...
public:
	...
	static ref<java::util::Set> getISOCountries(ref<java::util::Locale_IsoCountryCode> type);
	...
	ref<java::lang::String> getDisplayLanguage(ref<java::util::Locale> inLocale);
	...
	ref<java::lang::String> getDisplayCountry(ref<java::util::Locale> inLocale);
	...
	ref<java::lang::String> getDisplayName(ref<java::util::Locale> inLocale);
...
inline ref<java::util::Set> Locale::getISOCountries(ref<java::util::Locale_IsoCountryCode> type) { return call_static_method<SCAPIX_META_STRING("getISOCountries"), ref<java::util::Set>>(type); }
...
inline ref<java::lang::String> Locale::getDisplayLanguage(ref<java::util::Locale> inLocale) { return call_method<SCAPIX_META_STRING("getDisplayLanguage"), ref<java::lang::String>>(inLocale); }
...
inline ref<java::lang::String> Locale::getDisplayCountry(ref<java::util::Locale> inLocale) { return call_method<SCAPIX_META_STRING("getDisplayCountry"), ref<java::lang::String>>(inLocale); }
...
inline ref<java::lang::String> Locale::getDisplayName(ref<java::util::Locale> inLocale) { return call_method<SCAPIX_META_STRING("getDisplayName"), ref<java::lang::String>>(inLocale); }
