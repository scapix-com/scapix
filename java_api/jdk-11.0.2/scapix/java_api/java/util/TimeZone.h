...
public:
	...
	static ref<java::util::TimeZone> getTimeZone(ref<java::lang::String> ID_);
	...
	static void setDefault(ref<java::util::TimeZone> zone);
...
inline ref<java::util::TimeZone> TimeZone::getTimeZone(ref<java::lang::String> ID_) { return call_static_method<SCAPIX_META_STRING("getTimeZone"), ref<java::util::TimeZone>>(ID_); }
...
inline void TimeZone::setDefault(ref<java::util::TimeZone> zone) { return call_static_method<SCAPIX_META_STRING("setDefault"), void>(zone); }
