...
public:
	...
	static ref<java::lang::Object> requireNonNullElse(ref<java::lang::Object> obj, ref<java::lang::Object> defaultObj);
	static ref<java::lang::Object> requireNonNullElseGet(ref<java::lang::Object> obj, ref<java::util::function::Supplier> supplier);
	static ref<java::lang::Object> requireNonNull(ref<java::lang::Object> obj, ref<java::util::function::Supplier> messageSupplier);
	static jint checkIndex(jint index, jint length);
	static jint checkFromToIndex(jint fromIndex, jint toIndex, jint length);
	static jint checkFromIndexSize(jint fromIndex, jint size, jint length);
...
inline ref<java::lang::Object> Objects::requireNonNullElse(ref<java::lang::Object> obj, ref<java::lang::Object> defaultObj) { return call_static_method<SCAPIX_META_STRING("requireNonNullElse"), ref<java::lang::Object>>(obj, defaultObj); }
inline ref<java::lang::Object> Objects::requireNonNullElseGet(ref<java::lang::Object> obj, ref<java::util::function::Supplier> supplier) { return call_static_method<SCAPIX_META_STRING("requireNonNullElseGet"), ref<java::lang::Object>>(obj, supplier); }
...
inline jint Objects::checkIndex(jint index, jint length) { return call_static_method<SCAPIX_META_STRING("checkIndex"), jint>(index, length); }
inline jint Objects::checkFromToIndex(jint fromIndex, jint toIndex, jint length) { return call_static_method<SCAPIX_META_STRING("checkFromToIndex"), jint>(fromIndex, toIndex, length); }
inline jint Objects::checkFromIndexSize(jint fromIndex, jint size, jint length) { return call_static_method<SCAPIX_META_STRING("checkFromIndexSize"), jint>(fromIndex, size, length); }
