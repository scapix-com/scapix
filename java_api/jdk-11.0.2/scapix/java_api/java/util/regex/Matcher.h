...
public:
	...
	ref<java::util::regex::Matcher> appendReplacement(ref<java::lang::StringBuilder> sb, ref<java::lang::String> replacement);
	ref<java::lang::StringBuffer> appendTail(ref<java::lang::StringBuffer> sb);
	ref<java::lang::StringBuilder> appendTail(ref<java::lang::StringBuilder> sb);
	ref<java::lang::String> replaceAll(ref<java::lang::String> replacement);
	ref<java::lang::String> replaceAll(ref<java::util::function::Function> replacer);
	ref<java::util::stream::Stream> results();
	ref<java::lang::String> replaceFirst(ref<java::lang::String> replacement);
	ref<java::lang::String> replaceFirst(ref<java::util::function::Function> replacer);
	ref<java::util::regex::Matcher> region(jint start, jint end);
	jint regionStart();
	jint regionEnd();
	jboolean hasTransparentBounds();
	ref<java::util::regex::Matcher> useTransparentBounds(jboolean b);
	jboolean hasAnchoringBounds();
	ref<java::util::regex::Matcher> useAnchoringBounds(jboolean b);
...
inline ref<java::util::regex::Matcher> Matcher::appendReplacement(ref<java::lang::StringBuilder> sb, ref<java::lang::String> replacement) { return call_method<SCAPIX_META_STRING("appendReplacement"), ref<java::util::regex::Matcher>>(sb, replacement); }
...
inline ref<java::lang::StringBuilder> Matcher::appendTail(ref<java::lang::StringBuilder> sb) { return call_method<SCAPIX_META_STRING("appendTail"), ref<java::lang::StringBuilder>>(sb); }
...
inline ref<java::lang::String> Matcher::replaceAll(ref<java::util::function::Function> replacer) { return call_method<SCAPIX_META_STRING("replaceAll"), ref<java::lang::String>>(replacer); }
inline ref<java::util::stream::Stream> Matcher::results() { return call_method<SCAPIX_META_STRING("results"), ref<java::util::stream::Stream>>(); }
...
inline ref<java::lang::String> Matcher::replaceFirst(ref<java::util::function::Function> replacer) { return call_method<SCAPIX_META_STRING("replaceFirst"), ref<java::lang::String>>(replacer); }
...
inline ref<java::util::regex::Matcher> Matcher::useTransparentBounds(jboolean b) { return call_method<SCAPIX_META_STRING("useTransparentBounds"), ref<java::util::regex::Matcher>>(b); }
inline jboolean Matcher::hasAnchoringBounds() { return call_method<SCAPIX_META_STRING("hasAnchoringBounds"), jboolean>(); }
inline ref<java::util::regex::Matcher> Matcher::useAnchoringBounds(jboolean b) { return call_method<SCAPIX_META_STRING("useAnchoringBounds"), ref<java::util::regex::Matcher>>(b); }
