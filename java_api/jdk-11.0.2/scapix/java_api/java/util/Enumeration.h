...
public:
	...
	ref<java::util::Iterator> asIterator();
...
inline ref<java::util::Iterator> Enumeration::asIterator() { return call_method<SCAPIX_META_STRING("asIterator"), ref<java::util::Iterator>>(); }
