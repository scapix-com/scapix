...
public:
	...
	jlong dividedBy(ref<java::time::Duration> divisor);
	...
	jint toMillisPart();
	jint toNanosPart();
	ref<java::time::Duration> truncatedTo(ref<java::time::temporal::TemporalUnit> unit);
...
inline jlong Duration::dividedBy(ref<java::time::Duration> divisor) { return call_method<SCAPIX_META_STRING("dividedBy"), jlong>(divisor); }
...
inline jlong Duration::toSeconds() { return call_method<SCAPIX_META_STRING("toSeconds"), jlong>(); }
...
inline jlong Duration::toDaysPart() { return call_method<SCAPIX_META_STRING("toDaysPart"), jlong>(); }
inline jint Duration::toHoursPart() { return call_method<SCAPIX_META_STRING("toHoursPart"), jint>(); }
inline jint Duration::toMinutesPart() { return call_method<SCAPIX_META_STRING("toMinutesPart"), jint>(); }
inline jint Duration::toSecondsPart() { return call_method<SCAPIX_META_STRING("toSecondsPart"), jint>(); }
inline jint Duration::toMillisPart() { return call_method<SCAPIX_META_STRING("toMillisPart"), jint>(); }
inline jint Duration::toNanosPart() { return call_method<SCAPIX_META_STRING("toNanosPart"), jint>(); }
inline ref<java::time::Duration> Duration::truncatedTo(ref<java::time::temporal::TemporalUnit> unit) { return call_method<SCAPIX_META_STRING("truncatedTo"), ref<java::time::Duration>>(unit); }
