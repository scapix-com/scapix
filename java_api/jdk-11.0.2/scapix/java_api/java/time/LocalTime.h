...
public:
	...
	static ref<java::time::LocalTime> ofInstant(ref<java::time::Instant> instant, ref<java::time::ZoneId> zone);
	...
	jint toSecondOfDay();
	jlong toNanoOfDay();
	jlong toEpochSecond(ref<java::time::LocalDate> date, ref<java::time::ZoneOffset> offset);
...
inline ref<java::time::LocalTime> LocalTime::ofInstant(ref<java::time::Instant> instant, ref<java::time::ZoneId> zone) { return call_static_method<SCAPIX_META_STRING("ofInstant"), ref<java::time::LocalTime>>(instant, zone); }
...
inline jlong LocalTime::toEpochSecond(ref<java::time::LocalDate> date, ref<java::time::ZoneOffset> offset) { return call_method<SCAPIX_META_STRING("toEpochSecond"), jlong>(date, offset); }
