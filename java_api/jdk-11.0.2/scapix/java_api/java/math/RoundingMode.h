...
public:
	...
	static ref<java::math::RoundingMode> valueOf(jint rm);
...
inline ref<java::math::RoundingMode> RoundingMode::valueOf(jint rm) { return call_static_method<SCAPIX_META_STRING("valueOf"), ref<java::math::RoundingMode>>(rm); }
