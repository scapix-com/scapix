...
public:
	...
	static ref<java::math::BigDecimal> valueOf(jlong val);
	...
	ref<java::math::BigDecimal> sqrt(ref<java::math::MathContext> mc);
...
inline ref<java::math::BigDecimal> BigDecimal::valueOf(jlong val) { return call_static_method<SCAPIX_META_STRING("valueOf"), ref<java::math::BigDecimal>>(val); }
...
inline ref<java::math::BigDecimal> BigDecimal::sqrt(ref<java::math::MathContext> mc) { return call_method<SCAPIX_META_STRING("sqrt"), ref<java::math::BigDecimal>>(mc); }
