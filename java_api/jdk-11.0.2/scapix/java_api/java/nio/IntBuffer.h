...
public:
	...
	jint arrayOffset();
	ref<java::nio::IntBuffer> position(jint newPosition);
	ref<java::nio::IntBuffer> limit(jint newLimit);
	ref<java::nio::IntBuffer> mark();
	ref<java::nio::IntBuffer> reset();
	ref<java::nio::IntBuffer> clear();
	ref<java::nio::IntBuffer> flip();
	ref<java::nio::IntBuffer> rewind();
	...
	jint mismatch(ref<java::nio::IntBuffer> that);
...
inline ref<java::nio::IntBuffer> IntBuffer::position(jint newPosition) { return call_method<SCAPIX_META_STRING("position"), ref<java::nio::IntBuffer>>(newPosition); }
inline ref<java::nio::IntBuffer> IntBuffer::limit(jint newLimit) { return call_method<SCAPIX_META_STRING("limit"), ref<java::nio::IntBuffer>>(newLimit); }
inline ref<java::nio::IntBuffer> IntBuffer::mark() { return call_method<SCAPIX_META_STRING("mark"), ref<java::nio::IntBuffer>>(); }
inline ref<java::nio::IntBuffer> IntBuffer::reset() { return call_method<SCAPIX_META_STRING("reset"), ref<java::nio::IntBuffer>>(); }
inline ref<java::nio::IntBuffer> IntBuffer::clear() { return call_method<SCAPIX_META_STRING("clear"), ref<java::nio::IntBuffer>>(); }
inline ref<java::nio::IntBuffer> IntBuffer::flip() { return call_method<SCAPIX_META_STRING("flip"), ref<java::nio::IntBuffer>>(); }
inline ref<java::nio::IntBuffer> IntBuffer::rewind() { return call_method<SCAPIX_META_STRING("rewind"), ref<java::nio::IntBuffer>>(); }
...
inline jint IntBuffer::mismatch(ref<java::nio::IntBuffer> that) { return call_method<SCAPIX_META_STRING("mismatch"), jint>(that); }
