...
public:
	...
	jint select();
	jint select(ref<java::util::function::Consumer> action, jlong timeout);
	jint select(ref<java::util::function::Consumer> action);
	jint selectNow(ref<java::util::function::Consumer> action);
...
inline jint Selector::select(ref<java::util::function::Consumer> action, jlong timeout) { return call_method<SCAPIX_META_STRING("select"), jint>(action, timeout); }
inline jint Selector::select(ref<java::util::function::Consumer> action) { return call_method<SCAPIX_META_STRING("select"), jint>(action); }
inline jint Selector::selectNow(ref<java::util::function::Consumer> action) { return call_method<SCAPIX_META_STRING("selectNow"), jint>(action); }
