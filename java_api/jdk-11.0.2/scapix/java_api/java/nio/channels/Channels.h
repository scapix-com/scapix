...
public:
	...
	static ref<java::io::Reader> newReader(ref<java::nio::channels::ReadableByteChannel> ch, ref<java::nio::charset::Charset> charset);
	...
	static ref<java::io::Writer> newWriter(ref<java::nio::channels::WritableByteChannel> ch, ref<java::nio::charset::Charset> charset);
...
inline ref<java::io::Reader> Channels::newReader(ref<java::nio::channels::ReadableByteChannel> ch, ref<java::nio::charset::Charset> charset) { return call_static_method<SCAPIX_META_STRING("newReader"), ref<java::io::Reader>>(ch, charset); }
...
inline ref<java::io::Writer> Channels::newWriter(ref<java::nio::channels::WritableByteChannel> ch, ref<java::nio::charset::Charset> charset) { return call_static_method<SCAPIX_META_STRING("newWriter"), ref<java::io::Writer>>(ch, charset); }
