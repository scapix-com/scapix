...
public:
	...
	jint arrayOffset();
	ref<java::nio::ShortBuffer> position(jint newPosition);
	ref<java::nio::ShortBuffer> limit(jint newLimit);
	ref<java::nio::ShortBuffer> mark();
	ref<java::nio::ShortBuffer> reset();
	ref<java::nio::ShortBuffer> clear();
	ref<java::nio::ShortBuffer> flip();
	ref<java::nio::ShortBuffer> rewind();
	...
	jint mismatch(ref<java::nio::ShortBuffer> that);
...
inline ref<java::nio::ShortBuffer> ShortBuffer::position(jint newPosition) { return call_method<SCAPIX_META_STRING("position"), ref<java::nio::ShortBuffer>>(newPosition); }
inline ref<java::nio::ShortBuffer> ShortBuffer::limit(jint newLimit) { return call_method<SCAPIX_META_STRING("limit"), ref<java::nio::ShortBuffer>>(newLimit); }
inline ref<java::nio::ShortBuffer> ShortBuffer::mark() { return call_method<SCAPIX_META_STRING("mark"), ref<java::nio::ShortBuffer>>(); }
inline ref<java::nio::ShortBuffer> ShortBuffer::reset() { return call_method<SCAPIX_META_STRING("reset"), ref<java::nio::ShortBuffer>>(); }
inline ref<java::nio::ShortBuffer> ShortBuffer::clear() { return call_method<SCAPIX_META_STRING("clear"), ref<java::nio::ShortBuffer>>(); }
inline ref<java::nio::ShortBuffer> ShortBuffer::flip() { return call_method<SCAPIX_META_STRING("flip"), ref<java::nio::ShortBuffer>>(); }
inline ref<java::nio::ShortBuffer> ShortBuffer::rewind() { return call_method<SCAPIX_META_STRING("rewind"), ref<java::nio::ShortBuffer>>(); }
...
inline jint ShortBuffer::mismatch(ref<java::nio::ShortBuffer> that) { return call_method<SCAPIX_META_STRING("mismatch"), jint>(that); }
