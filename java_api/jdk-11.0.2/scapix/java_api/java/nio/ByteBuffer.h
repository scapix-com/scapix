...
public:
	...
	jint arrayOffset();
	ref<java::nio::ByteBuffer> position(jint newPosition);
	ref<java::nio::ByteBuffer> limit(jint newLimit);
	ref<java::nio::ByteBuffer> mark();
	ref<java::nio::ByteBuffer> reset();
	ref<java::nio::ByteBuffer> clear();
	ref<java::nio::ByteBuffer> flip();
	ref<java::nio::ByteBuffer> rewind();
	...
	jint mismatch(ref<java::nio::ByteBuffer> that);
	ref<java::nio::ByteOrder> order();
	ref<java::nio::ByteBuffer> order(ref<java::nio::ByteOrder> bo);
	jint alignmentOffset(jint index, jint unitSize);
	ref<java::nio::ByteBuffer> alignedSlice(jint unitSize);
	jchar getChar();
...
inline ref<java::nio::ByteBuffer> ByteBuffer::position(jint newPosition) { return call_method<SCAPIX_META_STRING("position"), ref<java::nio::ByteBuffer>>(newPosition); }
inline ref<java::nio::ByteBuffer> ByteBuffer::limit(jint newLimit) { return call_method<SCAPIX_META_STRING("limit"), ref<java::nio::ByteBuffer>>(newLimit); }
inline ref<java::nio::ByteBuffer> ByteBuffer::mark() { return call_method<SCAPIX_META_STRING("mark"), ref<java::nio::ByteBuffer>>(); }
inline ref<java::nio::ByteBuffer> ByteBuffer::reset() { return call_method<SCAPIX_META_STRING("reset"), ref<java::nio::ByteBuffer>>(); }
inline ref<java::nio::ByteBuffer> ByteBuffer::clear() { return call_method<SCAPIX_META_STRING("clear"), ref<java::nio::ByteBuffer>>(); }
inline ref<java::nio::ByteBuffer> ByteBuffer::flip() { return call_method<SCAPIX_META_STRING("flip"), ref<java::nio::ByteBuffer>>(); }
inline ref<java::nio::ByteBuffer> ByteBuffer::rewind() { return call_method<SCAPIX_META_STRING("rewind"), ref<java::nio::ByteBuffer>>(); }
...
inline jint ByteBuffer::mismatch(ref<java::nio::ByteBuffer> that) { return call_method<SCAPIX_META_STRING("mismatch"), jint>(that); }
...
inline jint ByteBuffer::alignmentOffset(jint index, jint unitSize) { return call_method<SCAPIX_META_STRING("alignmentOffset"), jint>(index, unitSize); }
inline ref<java::nio::ByteBuffer> ByteBuffer::alignedSlice(jint unitSize) { return call_method<SCAPIX_META_STRING("alignedSlice"), ref<java::nio::ByteBuffer>>(unitSize); }
