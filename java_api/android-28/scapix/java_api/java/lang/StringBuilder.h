...
inline void StringBuilder::trimToSize() { return call_method<SCAPIX_META_STRING("trimToSize"), void>(); }
inline jint StringBuilder::codePointAt(jint index) { return call_method<SCAPIX_META_STRING("codePointAt"), jint>(index); }
inline void StringBuilder::getChars(jint srcBegin, jint srcEnd, ref<link::java::array<jchar>> dst, jint dstBegin) { return call_method<SCAPIX_META_STRING("getChars"), void>(srcBegin, srcEnd, dst, dstBegin); }
inline jint StringBuilder::length() { return call_method<SCAPIX_META_STRING("length"), jint>(); }
inline void StringBuilder::setCharAt(jint index, jchar ch) { return call_method<SCAPIX_META_STRING("setCharAt"), void>(index, ch); }
inline ref<java::lang::CharSequence> StringBuilder::subSequence(jint start, jint end) { return call_method<SCAPIX_META_STRING("subSequence"), ref<java::lang::CharSequence>>(start, end); }
inline ref<java::lang::String> StringBuilder::substring(jint start) { return call_method<SCAPIX_META_STRING("substring"), ref<java::lang::String>>(start); }
inline ref<java::lang::String> StringBuilder::substring(jint start, jint end) { return call_method<SCAPIX_META_STRING("substring"), ref<java::lang::String>>(start, end); }
inline jint StringBuilder::capacity() { return call_method<SCAPIX_META_STRING("capacity"), jint>(); }
inline void StringBuilder::setLength(jint newLength) { return call_method<SCAPIX_META_STRING("setLength"), void>(newLength); }
inline void StringBuilder::ensureCapacity(jint minimumCapacity) { return call_method<SCAPIX_META_STRING("ensureCapacity"), void>(minimumCapacity); }
inline jint StringBuilder::codePointBefore(jint index) { return call_method<SCAPIX_META_STRING("codePointBefore"), jint>(index); }
inline jchar StringBuilder::charAt(jint index) { return call_method<SCAPIX_META_STRING("charAt"), jchar>(index); }
inline jint StringBuilder::codePointCount(jint beginIndex, jint endIndex) { return call_method<SCAPIX_META_STRING("codePointCount"), jint>(beginIndex, endIndex); }
inline jint StringBuilder::offsetByCodePoints(jint index, jint codePointOffset) { return call_method<SCAPIX_META_STRING("offsetByCodePoints"), jint>(index, codePointOffset); }
