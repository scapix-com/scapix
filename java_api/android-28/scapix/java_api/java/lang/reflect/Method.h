...
public:
	...
	ref<java::lang::Object> invoke(ref<java::lang::Object> p1, ref<link::java::array<java::lang::Object>> p2);
	jboolean isBridge();
	jboolean isVarArgs();
...
inline ref<java::lang::Object> Method::invoke(ref<java::lang::Object> p1, ref<link::java::array<java::lang::Object>> p2) { return call_method<SCAPIX_META_STRING("invoke"), ref<java::lang::Object>>(p1, p2); }
