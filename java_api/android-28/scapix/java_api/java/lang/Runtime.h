...
public:
	...
	ref<java::io::InputStream> getLocalizedInputStream(ref<java::io::InputStream> in);
	ref<java::io::OutputStream> getLocalizedOutputStream(ref<java::io::OutputStream> out);
...
inline void Runtime::runFinalizersOnExit(jboolean value) { return call_static_method<SCAPIX_META_STRING("runFinalizersOnExit"), void>(value); }
...
inline ref<java::io::InputStream> Runtime::getLocalizedInputStream(ref<java::io::InputStream> in) { return call_method<SCAPIX_META_STRING("getLocalizedInputStream"), ref<java::io::InputStream>>(in); }
inline ref<java::io::OutputStream> Runtime::getLocalizedOutputStream(ref<java::io::OutputStream> out) { return call_method<SCAPIX_META_STRING("getLocalizedOutputStream"), ref<java::io::OutputStream>>(out); }
