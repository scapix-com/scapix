...
public:
	...
	jboolean isInstance(ref<java::lang::Object> obj);
	jboolean isAssignableFrom(ref<java::lang::Class> cls);
	...
	ref<java::lang::reflect::Field> getDeclaredField(ref<java::lang::String> p1);
	...
	ref<java::lang::annotation::Annotation> getDeclaredAnnotation(ref<java::lang::Class> p1);
...
inline jboolean Class::isInstance(ref<java::lang::Object> obj) { return call_method<SCAPIX_META_STRING("isInstance"), jboolean>(obj); }
inline jboolean Class::isAssignableFrom(ref<java::lang::Class> cls) { return call_method<SCAPIX_META_STRING("isAssignableFrom"), jboolean>(cls); }
...
inline ref<java::lang::reflect::Field> Class::getDeclaredField(ref<java::lang::String> p1) { return call_method<SCAPIX_META_STRING("getDeclaredField"), ref<java::lang::reflect::Field>>(p1); }
...
inline ref<java::lang::annotation::Annotation> Class::getDeclaredAnnotation(ref<java::lang::Class> p1) { return call_method<SCAPIX_META_STRING("getDeclaredAnnotation"), ref<java::lang::annotation::Annotation>>(p1); }
