...
inline jdouble StrictMath::exp(jdouble p1) { return call_static_method<SCAPIX_META_STRING("exp"), jdouble>(p1); }
...
inline jdouble StrictMath::cbrt(jdouble p1) { return call_static_method<SCAPIX_META_STRING("cbrt"), jdouble>(p1); }
...
inline jdouble StrictMath::pow(jdouble p1, jdouble p2) { return call_static_method<SCAPIX_META_STRING("pow"), jdouble>(p1, p2); }
...
inline jdouble StrictMath::hypot(jdouble p1, jdouble p2) { return call_static_method<SCAPIX_META_STRING("hypot"), jdouble>(p1, p2); }
