...
public:
	...
	void finish();
	jboolean finished();
	jint deflate(ref<link::java::array<jbyte>> b, jint off, jint len);
	jint deflate(ref<link::java::array<jbyte>> b);
	jint deflate(ref<link::java::array<jbyte>> b, jint off, jint len, jint flush);
	jint getAdler();
	jint getTotalIn();
	jlong getBytesRead();
	jint getTotalOut();
...
inline void Deflater::setInput(ref<link::java::array<jbyte>> b, jint off, jint len) { return call_method<SCAPIX_META_STRING("setInput"), void>(b, off, len); }
inline void Deflater::setInput(ref<link::java::array<jbyte>> b) { return call_method<SCAPIX_META_STRING("setInput"), void>(b); }
inline void Deflater::setDictionary(ref<link::java::array<jbyte>> b, jint off, jint len) { return call_method<SCAPIX_META_STRING("setDictionary"), void>(b, off, len); }
inline void Deflater::setDictionary(ref<link::java::array<jbyte>> b) { return call_method<SCAPIX_META_STRING("setDictionary"), void>(b); }
...
inline jint Deflater::deflate(ref<link::java::array<jbyte>> b, jint off, jint len) { return call_method<SCAPIX_META_STRING("deflate"), jint>(b, off, len); }
inline jint Deflater::deflate(ref<link::java::array<jbyte>> b) { return call_method<SCAPIX_META_STRING("deflate"), jint>(b); }
inline jint Deflater::deflate(ref<link::java::array<jbyte>> b, jint off, jint len, jint flush) { return call_method<SCAPIX_META_STRING("deflate"), jint>(b, off, len, flush); }
