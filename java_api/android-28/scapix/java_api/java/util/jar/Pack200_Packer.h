...
inline void Pack200_Packer::addPropertyChangeListener(ref<java::beans::PropertyChangeListener> listener) { return call_method<SCAPIX_META_STRING("addPropertyChangeListener"), void>(listener); }
inline void Pack200_Packer::removePropertyChangeListener(ref<java::beans::PropertyChangeListener> listener) { return call_method<SCAPIX_META_STRING("removePropertyChangeListener"), void>(listener); }
