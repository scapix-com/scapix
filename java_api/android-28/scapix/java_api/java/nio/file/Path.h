...
public:
	...
	jboolean startsWith(ref<java::lang::String> p1);
	jboolean endsWith(ref<java::nio::file::Path> p1);
	jboolean endsWith(ref<java::lang::String> p1);
	ref<java::nio::file::Path> normalize();
	ref<java::nio::file::Path> resolve(ref<java::nio::file::Path> p1);
	ref<java::nio::file::Path> resolve(ref<java::lang::String> p1);
	ref<java::nio::file::Path> resolveSibling(ref<java::nio::file::Path> p1);
	ref<java::nio::file::Path> resolveSibling(ref<java::lang::String> p1);
...
inline jboolean Path::startsWith(ref<java::lang::String> p1) { return call_method<SCAPIX_META_STRING("startsWith"), jboolean>(p1); }
inline jboolean Path::endsWith(ref<java::nio::file::Path> p1) { return call_method<SCAPIX_META_STRING("endsWith"), jboolean>(p1); }
inline jboolean Path::endsWith(ref<java::lang::String> p1) { return call_method<SCAPIX_META_STRING("endsWith"), jboolean>(p1); }
...
inline ref<java::nio::file::Path> Path::resolve(ref<java::lang::String> p1) { return call_method<SCAPIX_META_STRING("resolve"), ref<java::nio::file::Path>>(p1); }
inline ref<java::nio::file::Path> Path::resolveSibling(ref<java::nio::file::Path> p1) { return call_method<SCAPIX_META_STRING("resolveSibling"), ref<java::nio::file::Path>>(p1); }
inline ref<java::nio::file::Path> Path::resolveSibling(ref<java::lang::String> p1) { return call_method<SCAPIX_META_STRING("resolveSibling"), ref<java::nio::file::Path>>(p1); }
...
inline ref<java::nio::file::WatchKey> Path::register_(ref<java::nio::file::WatchService> p1, ref<link::java::array<java::nio::file::WatchEvent_Kind>> p2) { return call_method<SCAPIX_META_STRING("register"), ref<java::nio::file::WatchKey>>(p1, p2); }
