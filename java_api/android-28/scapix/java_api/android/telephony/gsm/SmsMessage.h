...
#ifndef SCAPIX_ANDROID_TELEPHONY_GSM_SMSMESSAGE_H
#define SCAPIX_ANDROID_TELEPHONY_GSM_SMSMESSAGE_H

namespace scapix::java_api {

namespace android::telephony::gsm { class SmsMessage_MessageClass; }
namespace android::telephony::gsm { class SmsMessage_SubmitPdu; }
namespace java::lang { class CharSequence; }
namespace java::lang { class String; }

namespace android::telephony::gsm {

class SmsMessage : public object_base<SCAPIX_META_STRING("android/telephony/gsm/SmsMessage"),
	java::lang::Object>
{
public:
	...
	static ref<SmsMessage> new_object();
	static ref<android::telephony::gsm::SmsMessage> createFromPdu(ref<link::java::array<jbyte>> pdu);
	static jint getTPLayerLengthForPDU(ref<java::lang::String> pdu);
	static ref<link::java::array<jint>> calculateLength(ref<java::lang::CharSequence> messageBody, jboolean use7bitOnly);
	static ref<link::java::array<jint>> calculateLength(ref<java::lang::String> messageBody, jboolean use7bitOnly);
	static ref<android::telephony::gsm::SmsMessage_SubmitPdu> getSubmitPdu(ref<java::lang::String> scAddress, ref<java::lang::String> destinationAddress, ref<java::lang::String> message, jboolean statusReportRequested);
	static ref<android::telephony::gsm::SmsMessage_SubmitPdu> getSubmitPdu(ref<java::lang::String> scAddress, ref<java::lang::String> destinationAddress, jshort destinationPort, ref<link::java::array<jbyte>> data, jboolean statusReportRequested);
	...
	ref<android::telephony::gsm::SmsMessage_MessageClass> getMessageClass();
...
#include <scapix/java_api/android/telephony/gsm/SmsMessage_MessageClass.h>
#include <scapix/java_api/android/telephony/gsm/SmsMessage_SubmitPdu.h>
...
inline ref<SmsMessage> SmsMessage::new_object() { return base_::new_object(); }
inline ref<android::telephony::gsm::SmsMessage> SmsMessage::createFromPdu(ref<link::java::array<jbyte>> pdu) { return call_static_method<SCAPIX_META_STRING("createFromPdu"), ref<android::telephony::gsm::SmsMessage>>(pdu); }
...
inline ref<link::java::array<jint>> SmsMessage::calculateLength(ref<java::lang::CharSequence> messageBody, jboolean use7bitOnly) { return call_static_method<SCAPIX_META_STRING("calculateLength"), ref<link::java::array<jint>>>(messageBody, use7bitOnly); }
...
inline ref<android::telephony::gsm::SmsMessage_SubmitPdu> SmsMessage::getSubmitPdu(ref<java::lang::String> scAddress, ref<java::lang::String> destinationAddress, ref<java::lang::String> message, jboolean statusReportRequested) { return call_static_method<SCAPIX_META_STRING("getSubmitPdu"), ref<android::telephony::gsm::SmsMessage_SubmitPdu>>(scAddress, destinationAddress, message, statusReportRequested); }
inline ref<android::telephony::gsm::SmsMessage_SubmitPdu> SmsMessage::getSubmitPdu(ref<java::lang::String> scAddress, ref<java::lang::String> destinationAddress, jshort destinationPort, ref<link::java::array<jbyte>> data, jboolean statusReportRequested) { return call_static_method<SCAPIX_META_STRING("getSubmitPdu"), ref<android::telephony::gsm::SmsMessage_SubmitPdu>>(scAddress, destinationAddress, destinationPort, data, statusReportRequested); }
...
inline ref<android::telephony::gsm::SmsMessage_MessageClass> SmsMessage::getMessageClass() { return call_method<SCAPIX_META_STRING("getMessageClass"), ref<android::telephony::gsm::SmsMessage_MessageClass>>(); }
...
#endif // SCAPIX_ANDROID_TELEPHONY_GSM_SMSMESSAGE_H
