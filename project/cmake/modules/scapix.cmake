...
foreach(filename ${bridge_headers})
    ...
    file(APPEND "${generated_java_cpp}" "#include \"${name}\"\n")
endforeach(filename)
file(APPEND "${generated_java_cpp}" "
...
foreach(filename ${bridge_headers})
    ...
    file(APPEND "${generated_java_cpp}" "    ${scapix_project_name}::generated::${name}_methods::register_();\n")
endforeach(filename)
file(APPEND "${generated_java_cpp}" "
    return result;
  }
...
foreach(bridge_header ${bridge_headers})
    ...
    list(APPEND output_files_java
            ...
            "${PROJECT_ROOT}/generated/bridge/java/${bridge_header_name}_decl.h"
